...
export const editorLib: EditorLibMessages = {
  ...
  rawKindComment: 'Notiz an dich',
  rawKindMath: 'Formel',
  rawKindImport: 'Stil eingebunden',
  rawKindSetting: 'Einstellung',
  rawKindRule: 'Regel',
  rawKindPageSetup: 'Seiteneinrichtung',
  rawKindBinding: 'Definition',
  rawKindSpacing: (amount: string): string => `Abstand · ${amount}`,
  rawKindPagebreak: 'Seitenumbruch',
  rawKindColbreak: 'Spaltenumbruch',
  rawKindLine: 'Trennlinie',
  rawKindCall: (name: string): string => `${name} · Gestaltung`,
  rawKindCode: 'Typst-Code',
  rawKindText: 'Textabschnitt',
