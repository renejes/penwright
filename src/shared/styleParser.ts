...
export const STYLE_TYPST_MARKER = '// penwright:generated-style — edit via Settings → Style';
 ...
 */
export const CUSTOM_BLOCK_START = '// ─── penwright:custom — your free-form Typst goes here ───';
...
export function generateStyleTypst(style: ProjectStyle): string {
  ...
  push('//');
  push('// Generated by Penwright. Values live in `.penwright/style.json` and can');
  push('// be edited via the Design sidebar tab. Manual edits to the fenced');
  push('// `penwright:custom` block at the bottom of `apply-style` are preserved');
...
//   // penwright:section-style
//   #import "../style.typ": feature-style
//   #show: feature-style
//   // penwright:section-style-end
// The block is a comment-led raw block, so it round-trips verbatim through the
// editor and is skipped by the DOCX export.

export const SECTION_BLOCK_START = '// penwright:section-style';
export const SECTION_BLOCK_END = '// penwright:section-style-end';
