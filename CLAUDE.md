...
- `project:open`, `project:close`, `project:newFolder`, `project:addAssets`, `project:listBackups`, `project:loadBackup`, `project:applyBackup`, `project:getBackupConfig`, `project:setBackupConfig`, `project:openBackupFolder`, `project:showInFinder`, `project:findSourceForCitation`, `project:getInfo`
