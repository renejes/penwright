...
> **Stand:** 2026-06-14, Ende der Print-Export-Session (Session 34). **Committet + gepusht auf `main`**; ein frisches, notarisiertes + gestapeltes Release-DMG liegt in `release/`.
