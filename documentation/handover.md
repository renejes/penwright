...
- **Achtung Packaging:** die **x86_64-Binary** ist noch alt — `npm run build:mcp-binary:all` (läuft in `package:mac`) baut beide Architekturen; für ein Release nötig.
