...
> - ⏳ Offen: Sektionen **4 (Dead Code)**, **5 (Duplikation)**, **6 (Plausible)**. Bekannte akzeptierte Limitation aus dem Review: die neue PM-basierte Suche findet keinen Text mehr in Node-**Attrs** (Opener-Titel, Captions, Raw-Block-Bodies) — Attr-Treffer wären nicht ersetzbar; als Follow-up notiert.
