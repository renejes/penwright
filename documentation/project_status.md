...
>
> **Stand:** 2026-06-08 (nach Session 31: **UI-Polish + zwei Bugfixes** — StartScreen aufgeräumt; `app:checkTypst`-Dauerfehler + git-lose Versionierung gefixt; MCP Apps + Design-Vorher/Nachher evaluiert → verworfen). Kurz:
