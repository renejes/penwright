...
> **Stand:** 2026-09-24 · App **0.15.2** · `MCP_SETUP_VERSION` **0.43.0** · Typst **0.15.1** · MCP **66 Tools** · SDK `@modelcontextprotocol/server` **2.0.0** · `@cursor/sdk` **1.0.x** (In-App-Agent)
>
