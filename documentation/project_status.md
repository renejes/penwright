...
>
> **Stand:** 2026-06-29 (nach Session 36: **Pre-Launch-Bugfixes + Web-Export Phase A + B** — der HTML-/Web-Export kommt vor den Launch). Kurz:
...
> **Version:** 0.9.0 (Pre-Release) — package.json + Doku synchron. **Nächste Aufgabe:** 🔑 **Web-Export Phase C (Keystone)** — Magazin-Makros → echte AST-Nodes (tragen nach PDF + DOCX + HTML), dann Phase D/E (Web-Export fertig), **dann** der Release-Sprint (`penwright.online` registrieren etc.). Details: `handover.md` + [web-export-feasibility-and-plan.md](web-export-feasibility-and-plan.md).
