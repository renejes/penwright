...
![version](https://img.shields.io/badge/version-0.15.3-3b6ea5)
...
Pre-release **0.15.3**. macOS / Apple Silicon is built and Developer-ID signed, not notarized. Windows is
